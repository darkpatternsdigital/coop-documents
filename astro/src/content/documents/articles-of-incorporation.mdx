...
export const Purpose = makeRef({ to: "Purpose" });
export const LimitedLiability = makeRef({ to: "Limitation on Director Liability" });
export const BylawsAmendment = makeRef({ to: "Amendment of Bylaws" });
...
3. Notwithstanding the foregoing, nothing set forth in Section 6.2 above is
   intended to or shall:
    ...
    3. create any additional or special rights or causes of action in favor of
       ...
       the third parties specified in this Section 6.2 above.
